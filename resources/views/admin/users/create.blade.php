...
<div class="form-wrap">
    <div class="form-header">
        <div class="breadcrumb-text">Manajemen User → Tambah Baru</div>
        <h1>👤 Tambah User Baru</h1>
        <p>Isi data lengkap penghuni baru</p>
    </div>
            ...
            <div class="form-card">
                ...
                <div class="field-row">
                    ...
                    <div class="field-group">
                        ...
                        <input type="text" name="no_tlp" value="{{ old('no_tlp') }}" placeholder="08xxxxxxxxxx" required>
                    </div>
                </div>
                ...
                <div class="field-row">
                    <div class="field-group">
                        ...
                        <input type="text" name="no_rumah" value="{{ old('no_rumah') }}" placeholder="Contoh: A-12" required>
                    </div>
                    <div class="field-group">
                        <label>Alamat</label>
