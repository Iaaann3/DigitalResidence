...
use Illuminate\Support\Str;  // Tambahin ini buat Str::limit di view, kalau belum ada
...
class IklanController extends Controller
{
    public function index()
    {
        ...
        // Debug: Log data iklans buat cek gambar path (liat di storage/logs/laravel.log)
        \Log::info('Iklans data:', $iklans->toArray());
    ...
    public function store(Request $request)
    {
        ...
        DB::transaction(function () use ($request) {
            ...
            if ($request->hasFile('gambar')) {
                // Simpan ke disk 'public' (bukan default)
